...
export const metadata: Metadata = {
  ...
  description: "Build a more abundant future—more housing, better transportation, clean energy, and efficient government for everyone.",
  keywords: ["DC", "Washington DC", "DMV", "abundance", "housing", "transportation", "energy", "government", "policy", "federal"],
