...
const imageCredits = [
  ...
  {
    image: 'fourth-of-july-fireworks.jpg',
    title: 'Fourth of July Washington D.C. Washington Monument National Mall',
    photographer: 'Anthony Quintano',
    photographerUrl: 'https://www.flickr.com/people/quintanomedia/',
    source: 'Wikimedia Commons',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Fourth_of_July_Washington_D.C._Washington_Monument_National_Mall_(52195797136).jpg',
    license: 'CC BY 2.0',
    licenseUrl: 'https://creativecommons.org/licenses/by/2.0/',
    usage: 'Events page',
  },
  {
    image: 'u-street-neighborhood.jpg',
    title: '1200 Block of U Street NW',
    photographer: 'Ted Eytan',
    photographerUrl: 'https://www.flickr.com/photos/taedc/',
    source: 'Wikimedia Commons',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:1200_block_of_U_Street_NW.jpg',
    license: 'CC BY-SA 2.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/2.0/',
    usage: 'Contact page',
  },
  {
    image: 'eastern-market.jpg',
    title: 'Eastern Market Facade',
    photographer: 'AgnosticPreachersKid',
    photographerUrl: 'https://commons.wikimedia.org/wiki/User:AgnosticPreachersKid',
    source: 'Wikimedia Commons',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Eastern_Market_-_facade.JPG',
    license: 'CC BY-SA 3.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0/',
    usage: 'About page',
  },
  {
    image: 'lincoln-memorial-sunset.jpg',
    title: 'Lincoln Memorial Reflecting Pool',
    photographer: 'Dsdugan',
    photographerUrl: 'https://commons.wikimedia.org/wiki/User:Dsdugan',
    source: 'Wikimedia Commons',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:15_23_0125_lincoln_memorial.jpg',
    license: 'CC BY-SA 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0/',
    usage: 'Focus Areas page',
  },
];
