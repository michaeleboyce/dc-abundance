        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-12 space-y-6 text-lg md:text-xl text-neutral-600 leading-relaxed">
            <p>
              ...
              better infrastructure, cleaner energy—without sacrificing quality of life or
              environmental protection. It&apos;s about removing the barriers that make everything
              too expensive, too slow, and too hard.
            </p>
            <p className="text-neutral-700 border-l-4 border-accent-500 pl-6 py-2 text-left italic bg-accent-50/50 rounded-r-lg">
              &ldquo;In Washington, DC, that means tackling the challenges that affect everyone:
              the cost of housing, the reliability of Metro, the efficiency of government
              services, and our transition to clean energy. These aren&apos;t partisan issues—they&apos;re
              about making our city work for all residents.&rdquo;
            </p>
            <p>
              <strong className="text-primary-700 font-semibold">DC Abundance</strong> is a cross-partisan
              coalition of residents, advocates, and policymakers who believe our city can
              do better. We focus on practical solutions that expand opportunity and make
              DC more affordable, sustainable, and livable for everyone.
            </p>
          </div>
        </div>
      </Container>
